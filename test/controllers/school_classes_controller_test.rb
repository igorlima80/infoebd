...
class SchoolClassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create school_class" do
    assert_difference('SchoolClass.count') do
      post school_classes_url, params: { school_class: { description: @school_class.description, period_id: @school_class.period_id, teacher_id: @school_class.teacher_id } }
    end
  ...
  test "should update school_class" do
    patch school_class_url(@school_class), params: { school_class: { description: @school_class.description, period_id: @school_class.period_id, teacher_id: @school_class.teacher_id } }
