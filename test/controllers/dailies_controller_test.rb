...
class DailiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create daily" do
    assert_difference('Daily.count') do
      post dailies_url, params: { daily: { date_daily: @daily.date_daily, school_class_id: @daily.school_class_id } }
    end
  ...
  test "should update daily" do
    patch daily_url(@daily), params: { daily: { date_daily: @daily.date_daily, school_class_id: @daily.school_class_id } }
